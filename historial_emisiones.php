<?php
   require('conexion_emisiones.php');
   $claseConexion = new Conexiondb();
   $conexion = $claseConexion->crearconexion();
   $resultado = $conexion->query('SELECT anio, nombre_finca, emision_total, N2O_Excretas_en_pasturas, N2O_Manejo_de_Excretas FROM historial_emisiones');
