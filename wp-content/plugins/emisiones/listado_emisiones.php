                    ...
                    <?php
                        ...
                        if(is_array($registros)){
                            foreach($registros as $emision){
                                ...
                                echo "<td>".number_format($emision["metano_enterica"],2,',','.')."</td>";
                                echo "<td>".number_format($emision["metano_excretas"],2,',','.')."</td>";
                                echo "<td>".number_format($emision["N2O_excretas"],2,',','.')."</td>";
                                echo "<td>".number_format($emision["N2O_pasturas"],2,',','.')."</td>";
                                echo "<td>".number_format($emision["total_emisiones"],2,',','.')."</td>";
                                echo "<td>Edición</td>";
                              ...
                              //  echo ("estas en el usuario: ".$perfil);
                                ...
                                if($perfil == 'mate' || $perfil == 'innovacion'){
                                        echo '<td>
                                        <a class="btn me-md-2 visualizar_tooltip" id="visualizar"  href="http://localhost/esteveza/mostrar_emisiones?id='.$emision["id"].'" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="green" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                    ...
                                    //echo "esta aqui";
                                        ...
                                        echo '<a class="btn me-md-2 editar_tooltip" id="editar "  href="http://localhost/esteveza/editar-emisiones?id='.$emision["id"].'" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="blue" class="bi bi-pen-fill" viewBox="0 0 16 16">
                                        <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001"/>
                                        </svg></a>';
                                        echo '<button class="btn me-md-2 valida_tooltip" data-id='.$emision["id"].' id="validar" name="Validar"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="orange" class="bi bi-clipboard-check-fill" viewBox="0 0 16 16">
