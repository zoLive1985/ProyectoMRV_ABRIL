...
if ($props['image']) {
    ...
    $image = $this->el('image', [
        ...
        'class' => [
            ...
            'uk-margin[-{image_margin}]-top {@!image_margin: remove} {@!image_transition}' => $element['image_align'] == 'between' || ($element['image_align'] == 'bottom' && !($element['panel_style'] && $element['panel_card_image'])),
        ],
